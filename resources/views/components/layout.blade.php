...
user-select: none; /* Standard syntax */ font-family: Open Sans, sans-serif;">
    <section class="px-6 py-8">
        <nav class="md:flex md:justify-between md:items-center">
            <div>
                <a href="/">
                    <img src="/images/lionwire-removebg-preview.png" alt="Laracasts Logo" width="165" height="16">
                </a>
            </div>
            ...
            <div class="mt-8 md:mt-0 flex items-center">
                ...
                <x-dropdown>
                    ...
                    @endif
                    <x-dropdown-item href="/logout" x-data="{}" @click.prevent="document.querySelector('#Logout_FORM').submit()">Log out</x-dropdown-item>
                </x-dropdown>
                
                
                    <form action="/logout" method="post" id="Logout_FORM" class="hidden">
                        @csrf
